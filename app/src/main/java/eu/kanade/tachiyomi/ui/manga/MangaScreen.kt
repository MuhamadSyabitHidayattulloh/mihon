...
class MangaScreen(
    ...
    override fun Content() {
        ...
        MangaScreen(
            ...
            onMultiTranslateClicked = viewModel::translateChapters,
            onTranslateChapter = { viewModel.translateChapters(listOf(it)) },
            onDeleteTranslation = viewModel::deleteTranslation,
